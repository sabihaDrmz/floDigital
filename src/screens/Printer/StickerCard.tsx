...
import { PrinterConfigProp } from "../../core/services/PrinterConfigService";
import { GetServiceUri, ServiceUrlType } from "../../core/Settings";
import { PerfectFontSize } from "../../helper/PerfectPixel";

const StickerTag: React.FC<{
  sticker: PrinterConfigProp;
  selectedTag: number;
  onSelect: (config: PrinterConfigProp) => void;
  onImageClick?: () => void;
}> = (props) => {
  return (
    <TouchableOpacity
