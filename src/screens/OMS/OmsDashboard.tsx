...
import OmsStoreChiefReport from "./Partials/OmsStoreChiefReport";
...
const StoreChiefReport: React.FC<{ data: any }> = (props) => {
...
const OmsDashboard: React.FC = (props) => {
            ...
            <>
              ...
              OmsService.statePageData === undefined ? (
                ...
                <View style={{ flexDirection: "row" }}>
                  ...
                  {isInRole("omc-oms-store-chief") && (
                    <StoreChiefReport data={undefined} />
                  )}
                </View>
              )}
            </>
