          ...
          <FlatList
            ...
            data={OmsService.orderHistory?.Orders.filter(
              (x) =>
                ...
                (x.ActionByName.toUpperCase().includes(
                  ...
                  x.Action.toUpperCase().includes(searchQuery.toUpperCase()) ||
                  x.OrderNo.toUpperCase().includes(searchQuery.toUpperCase()) ||
            ...
            renderItem={({ item, index }) => (
              ...
              >
                ...
                {item.Action == "Kargo Mutakabat" && <AppButton
                  title={translate("OmsCargoConsensus.generateBarcode")}
                  buttonColorType={ColorType.Brand}
                  style={{ height: 40, paddingHorizontal: 6 }}
                  textStyle={{ fontSize: 11 }}
                  onPress={() => OmsService.printZpl(item.OrderNo)}
                />}
              </TouchableOpacity>
            )}
          />
          ...
          >
            ...
            >
              ...
              >
                        ...
                        return (
                          ...
                          >
                            ...
                            >
                              ...
                              {moment(x.ActionDate).format("DD/MM/YYYY HH:mm")}
                            </AppText>
                          </View>
                        );
                      })}
                ...
                {selectedOrderItem !== null && selectedOrderItem.length > 0 && (
                  <View>
                    <AppText
                      style={{
                        fontFamily: "Poppins_600SemiBold",
                    ...
                    <ScrollView style={{ paddingVertical: 10, height: 135 }}>
                      <FlatList
                        showsVerticalScrollIndicator={false}
                        scrollEventThrottle={16}
