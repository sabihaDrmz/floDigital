...
const RussiaQr: React.FC<any> = (props) => {
  ...
  const { product, kzQrCode, approveQrCode, kzQrCodeId, getQrCode, findKzQrCodeWithQrCode, findQrCode,findRussiaQrCode,setIsResidualProduct,russiaQrlist} = useProductService();
  const { selectedPrinter, printerConfig, printKzkQrCode,printProductTagRussia,printRussiankQrCode } = usePrinterConfigService();
    ...
    <View style={styles.container}>
      ...
      <View style={{ flex: 1 }}>
        ...
        <TouchableOpacity
          ...
          onPress={() => {
            // choseRadio(1);
            setIsResidualProduct(true);
            navigation.navigate("RussiaBarcodeCheck")
          }}
        >
          <AppText
            style={{
        ...
        >
          ...
          >
            Fiyat değişikliği etiketini yazdır
          </AppText>
          <View
            style={{
              width: PerfectPixelSize(20),
              ...
              <View style={{ flexDirection: "row" }}>
                ...
                <View style={{ justifyContent: "center" }}>
                  ...
                  <View style={{ flexDirection: "row", alignItems: "center" }}>
                    ...
                    >
                      левый {kzQrCode?.quantity} количество QR
                    </AppText>
                  </View>
                </View>
              </View>
          ...
          <AppButton
            ...
            onPress={() => {
              ...
              if (selectedRadio === 1) {
                ...
                printRussiankQrCode(kzQrCodeId, russiaQrlist?.qrResponseList[0]);
                closePopup();
              }
            }}
          />
              ...
              {selectedRadio === 1 ? (
                <View>
                  ...
                  >
                    ...
                    >
                    Вы уверены, что хотите создать QR-код?
                    </AppText>
                  </View>
                  <View
                    style={{
                    ...
                    <AppButton
                      ...
                      onPress={() => {
                        if (
                          ...
                          show(
                            "Пожалуйста, выполните поиск по номеру материала"
                          );
                          return;
                        }
                        ...
                        if (
                          ...
                          show(
                            isResidualWithMaterial
                              ? "Пожалуйста, введите номер материала"
                  ...
                  >
                    <AppButton
                      ...
                      onPress={() => {
                        ...
                        //   }
                        // );
                        findRussiaQrCode(parseInt(searchId)).then((res) => {
                          setOpenQrPopup(false);
                          res ? setQrResult(true) : setQrResult(false);
                        })
                      }}
                ...
                <View>
                  ...
                  >
                    ...
                    >
                      Вы уверены, что хотите распечатать этикетки возврата?
                    </AppText>
                  </View>
                  <View
                    style={{
