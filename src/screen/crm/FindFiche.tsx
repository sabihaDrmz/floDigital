...
import CrmTextBox from "../../components/Crm/CrmTextBox";
          ...
          <View style={{ padding: 20 }}>
            ...
            {Platform.OS === "web" ? (
              ...
              <>
                ...
                <AppText style={[styles.titleText, { marginTop: 10 }]} labelColorType={ColorType.Brand}>
                  Bitiş Tarih
                </AppText>
                <TouchableOpacity
                  onPress={() => {
                ...
                >
                  <AppText selectable>
                    {endDate !== "" ? endDate : "Bitiş Tarih Seçin"}
                  </AppText>
                  <DownIco color="#000" />
                </TouchableOpacity>
              </>
            ...
            <DateTimePickerModal
              isVisible={showDatePickerEndDate}
              mode="date"
              cancelTextIOS={translate(`easyRerturnFindFicheManual.dtpCancel`)}
              confirmTextIOS={translate(`easyRerturnFindFicheManual.dtpOk`)}
              //@ts-ignore
              ...
              onConfirm={(res: any) => {
                setShowDatePickerEndDate(false);
                setendDate(moment(res).format("DD/MM/YYYY"));
                setStartDate(res);
              }}
              onCancel={() => {
                setShowDatePickerEndDate(false);
